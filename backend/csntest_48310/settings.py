"""
Django settings for csntest_48310 project.
...
ROOT_URLCONF = 'csntest_48310.urls'
...
WSGI_APPLICATION = 'csntest_48310.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "csntest_48310 API",
    "DESCRIPTION": "API documentation for csntest_48310 App",
    "VERSION": "v1",
}
